...
logging.info("X de pruebas generado.")
logging.debug(f"\n{X_test}\n")

logging.info("y de entrenamiento generado.")
logging.debug(f"\n{y_train}\n")

logging.info("y de pruebas generado.")
logging.debug(f"\n{y_test}\n")
...
plt.savefig(os.path.join(OUT_FOLDER, "slr_data_split.jpg"))
plt.show()
# ------------------------------------------------------------
...
plt.title("Predicción con regresión linear simple")
plt.grid(True)

plt.savefig(os.path.join(OUT_FOLDER, "slr_model.jpg"))
plt.show()
